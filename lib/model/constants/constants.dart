class Constants {
  ...
  static const String searchPath = "$baseUrlSearch?$query=";
  static const String query = "top_rated";
  /* https://api.themoviedb.org/3/search/movie?query=fu&include_adult=false&language=en-US&page=1&api_key=5a941d4b4f72eb0bfdf088082292c0a1 */
}
